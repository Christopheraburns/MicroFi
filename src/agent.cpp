// agent.cpp -- the whole MicroFi agent behind microfi_agent_start().
//
// microfi_agent_start() runs once. We:
...
//   4. Bring up WiFi (or adopt the host's, CONFIG_MICROFI_WIFI_ADOPT_EXISTING).
...
// Then microfi_agent_start() returns and FreeRTOS continues running our tasks.
// On the XIAOs app_main() (main.cpp) is a two-line caller of this function;
// on the AMOLED (#188) the Brookesia host calls it instead.
...
extern "C" void microfi_agent_start(void) {
